            ...
            switch (selected_tokenA){
                ...
                case 3 :
                    ...
                    if(selected_tokenB == 1 && parseFloat(calcexchange(tokenA),10) < parseFloat(supply_ethsigz,10)){
                        await contract_mistersigz.methods.approve(contract_mistersigz.address,__token).send({from:account});
                    ...
                    if(selected_tokenB == 2 && parseFloat(calcexchange(tokenA),10) < parseFloat(supply_bee,10)){
                        await contract_mistersigz.methods.approve(contract_exchange_mistersigz,__token).send({from:account});
